  ...
  class ItemController < BaseController
    ...
    def create
      ...
      ::Todo::Item::Create
        ...
        .on_failure(:invalid_description) { |result| render_invalid_description(result) }
        .on_unknown { raise NotImplementedError }
    ...
    private
      ...
      def render_invalid_description(result)
        render_json(status: :unprocessable_entity, data: {description: result[:error]})
      end
  end
end
